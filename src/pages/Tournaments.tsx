        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-grow">
              ...
              <Input type="text" placeholder="Rechercher un tournoi..." className="pl-10" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
            </div>
            <div className="flex flex-col md:flex-row gap-4">
              <Select value={statusFilter} onValueChange={value => setStatusFilter(value as TournamentStatus | 'all')}>
              ...
              <Select value={typeFilter} onValueChange={value => setTypeFilter(value as TournamentType | 'all')}>
                <SelectTrigger className="w-[180px]">
